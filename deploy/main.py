...
from app.sns.setup_sns import create_sns_topic, subscribe_email_to_topic
...
def deploy(filename = "tasks.txt", key = "tasks.txt"):
    ...
    arn_topic = create_sns_topic("upload-notification") 
    print(arn_topic) 
    subscribe_email_to_topic(arn_topic, "uddithmachiraju@gmail.com") 
    ...
    lambda_func_response = create_lambda_function(function_name = "AWSIPP", region = region, 
                           ...
                           runtime = "python3.12", topic_arn = arn_topic) 
